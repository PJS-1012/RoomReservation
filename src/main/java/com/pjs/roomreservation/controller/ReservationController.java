...
import com.pjs.roomreservation.service.ReservationLockService;
...
public class ReservationController {
    ...
    public Long create(@AuthenticationPrincipal UserPrincipal principal, @Valid @RequestBody ReservationCreateDto req) {
        return reservationLockService.create(principal.getUserId(), req.getRoomId(), req.getStartAt(), req.getEndAt());
    }
